...
**The project is also the main repository to achieve the whole SDK delivery**, it contains the [west.yml](https://github.com/nxp-mcuxpresso/mcux-sdk/blob/main/west.yml) which keeps description and revision for other projects in the overall MCUXpresso delivery. 
...
* Clone/check-out a new delivery of whole SDK
    ...
    ```
    west init -m https://github.com/nxp-mcuxpresso/mcux-sdk --mr ${revision} mcuxsdk
    cd mcuxsdk
    west update
    ```
