...
{
    return ((base->IC_CON & (uint32_t)(I2C_IC_CON_MASTER_MODE_MASK | I2C_IC_CON_IC_SLAVE_DISABLE_MASK)) ==
...
static inline void I2C_MasterEnableGeneralCall(I2C_Type *base, bool enable)
{
    if (enable)
    {
        base->IC_TAR = (base->IC_TAR & ~(uint32_t)(I2C_IC_TAR_GC_OR_START_MASK)) | I2C_IC_TAR_SPECIAL_MASK;
    }
    else
    {
        base->IC_TAR &= ~(uint32_t)(I2C_IC_TAR_SPECIAL_MASK | I2C_IC_TAR_GC_OR_START_MASK);
    }
}
...
{
    return ((base->IC_CON & (uint32_t)(I2C_IC_CON_MASTER_MODE_MASK | I2C_IC_CON_IC_SLAVE_DISABLE_MASK)) == 0U);
}
