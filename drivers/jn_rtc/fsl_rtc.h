...
/*!
 * @brief Sets the 1Hz RTC time in seconds
 *
 * @param base      RTC peripheral base address
 * @param time      Time in seconds to be loaded in the RTC COUNT register.
 *
 */
static inline  void RTC_SetTimeSeconds(RTC_Type *base, const uint32_t time)
{
    /* Set time in seconds */
    base->COUNT = time;
}
...
/*!
 * @brief Returns the 1Hz RTC time in seconds.
 *
 * @param base      RTC peripheral base address
 *
 * @return          The value from the RTC COUNT register
 */
static inline uint32_t RTC_GetTimeSeconds(RTC_Type *base)
{
    return  base->COUNT;
}

/*!
 * @brief Sets the 1Hz RTC alarm time in seconds
 *
 * @param base      RTC peripheral base address
 * @param time      Time in seconds to be loaded in the RTC MATCH register.
 *
 */
static inline  void RTC_SetAlarmSeconds(RTC_Type *base, const uint32_t time)
{
    base->MATCH = time;
}

/*!
 * @brief Returns the 1Hz RTC alarm time in seconds.
 *
 * @param base      RTC peripheral base address
 *
 * @return          The value from the RTC MATCH register
 */
static inline uint32_t RTC_GetAlarmSeconds(RTC_Type *base)
{
    return  base->MATCH;
}
