...
我们建议您通过创建GitHub issue的方式来向我们报告代码中的错误和Bug。如果您想要请求项目加入新的功能，请检查 [贡献新组件](#contributing-new-components) 以提出您的想法。
...
| :exclamation: 注意 |
|:-----------------------------------------:|
|如果您的代码贡献包含了一些新的源文件来实现某个组件，请确保首先按照流程[贡献新的组件](#contributing-new-components) 来跟我们进行沟通。|
