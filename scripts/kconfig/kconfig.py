...
def main():
    ...
    configs_in = args.configs_in
    for idx, config in enumerate(configs_in):
        if config.endswith("config.cmake"):
            configs_in[idx] = misc.mcux_create_config_from_cmake(config)
    ...
    misc.mcux_create_config_cmake(args.config_out)
