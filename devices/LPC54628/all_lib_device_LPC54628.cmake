...
mcux_include_as_kconfig(driver_sha)
mcux_include_as_kconfig(driver_pint)
mcux_include_as_kconfig(driver_ctimer)
mcux_include_as_kconfig(driver_utick)
mcux_include_as_kconfig(driver_lpc_enet)
mcux_include_as_kconfig(driver_dmic)
...
mcux_include_as_kconfig(component_codec_i2c_LPC54628)
mcux_include_as_kconfig(driver_flexcomm)
mcux_include_as_kconfig(driver_flashiap)
...
mcux_include_as_kconfig(driver_fmeas)
mcux_include_as_kconfig(utility_debug_console)
mcux_include_as_kconfig(driver_lpc_crc)
mcux_include_as_kconfig(driver_otp)
mcux_include_as_kconfig(driver_mcan)
mcux_include_as_kconfig(driver_fmc)
mcux_include_as_kconfig(driver_phy-device-lan8720a)
...
mcux_include_as_kconfig(component_ctimer_adapter)
mcux_include_as_kconfig(driver_rit)
mcux_include_as_kconfig(driver_lpc_iocon)
mcux_include_as_kconfig(driver_spifi)
mcux_include_as_kconfig(driver_ft5406)
...
mcux_include_as_kconfig(driver_emc)
...
mcux_include_as_kconfig(driver_dmic_dma)
