...
#  set(CONFIG_USE_BOARD_Project_Template_imx95lpd5evk19 true)

#set.device.MIMX9596
#  # description: Device MIMX9596_startup
#  set(CONFIG_USE_device_MIMX9596_startup true)
...
#  set(CONFIG_USE_DEVICES_Project_Template_MIMX9596 true)

#  # description: Device MIMX9596_cmsis
#  set(CONFIG_USE_device_MIMX9596_CMSIS true)
...
#  set(CONFIG_USE_driver_phy-device-aqr113c true)
...
#  # description: RPMsg-Lite for i.MX95 baremetal application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_imx95_m7_bm true)

#  # description: RPMsg-Lite for mcimx95evk FreeRTOS application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_imx95_m7_freertos true)

#  # description: RPMsg-Lite baremetal for imx95 boards
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_bm_config true)

#  # description: RPMsg-Lite FreeRTOS for imx95 boards
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_freertos_config true)

#  # description: RPMsg-Lite for i.MX95 baremetal application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_imx95_m33_bm true)

#  # description: RPMsg-Lite for mcimx95evk FreeRTOS application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_imx95_m33_freertos true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../components/imx_sm/components/crc
  ${CMAKE_CURRENT_LIST_DIR}/../../components/imx_sm/components/scmi
  ${CMAKE_CURRENT_LIST_DIR}/../../components/imx_sm/components/smt
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../components/pcal6408
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../platform/drivers/netc/socs/imx95
...
include_if_use(BOARD_Project_Template_imx95lpd5evk19)
...
include_if_use(DEVICES_Project_Template_MIMX9596)
include_if_use(RTE_Device)
include_if_use(component_audio_sai_edma_adapter)
include_if_use(component_button)
include_if_use(component_codec_adapters)
include_if_use(component_codec_i2c)
include_if_use(component_common_task)
include_if_use(component_da7212_adapter)
include_if_use(component_hal_clock)
include_if_use(component_hal_clock_imx95)
include_if_use(component_hal_pinctrl)
include_if_use(component_hal_pinctrl_imx95)
include_if_use(component_hal_power)
include_if_use(component_hal_power_imx95)
include_if_use(component_i3c_adapter)
include_if_use(component_i3c_bus)
include_if_use(component_i3c_bus_adapter)
include_if_use(component_lists)
include_if_use(component_lpi2c_adapter)
include_if_use(component_lpit_adapter)
include_if_use(component_lpspi_adapter)
include_if_use(component_lptmr_adapter)
include_if_use(component_lpuart_adapter)
include_if_use(component_lpuart_dma_adapter)
include_if_use(component_mem_manager)
include_if_use(component_mem_manager_light)
...
include_if_use(component_panic)
include_if_use(component_pwm_tpm_adapter)
include_if_use(component_reset_adapter)
include_if_use(component_rgpio_adapter)
include_if_use(component_serial_manager)
include_if_use(component_serial_manager_spi)
include_if_use(component_serial_manager_swo)
include_if_use(component_serial_manager_uart)
include_if_use(component_serial_manager_virtual)
include_if_use(component_sgtl_adapter)
include_if_use(component_sm_clock)
include_if_use(component_sm_crc)
include_if_use(component_sm_imx95_cm33)
include_if_use(component_sm_imx95_cm7)
include_if_use(component_sm_pinctrl)
include_if_use(component_sm_power)
include_if_use(component_sm_scmi)
include_if_use(component_sm_smt)
include_if_use(component_software_crc_adapter)
include_if_use(component_software_rng_adapter)
include_if_use(component_timer_manager)
include_if_use(component_tpm_adapter)
include_if_use(component_wm8960_adapter)
include_if_use(component_wm8962_adapter)
include_if_use(device_MIMX9596_CMSIS)
include_if_use(device_MIMX9596_startup)
include_if_use(driver_adp5585)
include_if_use(driver_cache_armv7_m7)
include_if_use(driver_cache_xcache)
include_if_use(driver_camera-common)
include_if_use(driver_camera-device-common)
include_if_use(driver_camera-device-ov5640)
include_if_use(driver_camera-device-sccb)
include_if_use(driver_camera-receiver-common)
include_if_use(driver_camera-receiver-isi)
include_if_use(driver_camera_csr)
include_if_use(driver_clock)
include_if_use(driver_cmsis_lpi2c)
include_if_use(driver_cmsis_lpspi)
include_if_use(driver_cmsis_lpuart)
include_if_use(driver_codec)
include_if_use(driver_common)
include_if_use(driver_dc-fb-common)
include_if_use(driver_dialog7212)
include_if_use(driver_display-common)
include_if_use(driver_display-mipi-dsi-cmd)
include_if_use(driver_display-rm692c9)
include_if_use(driver_dpu_1)
include_if_use(driver_edma4)
include_if_use(driver_edma_soc)
include_if_use(driver_flexcan)
include_if_use(driver_flexcan_edma)
include_if_use(driver_flexio)
include_if_use(driver_flexio_camera)
include_if_use(driver_flexio_camera_edma)
include_if_use(driver_flexio_i2c_master)
include_if_use(driver_flexio_i2s)
include_if_use(driver_flexio_i2s_edma)
include_if_use(driver_flexio_mculcd)
include_if_use(driver_flexio_mculcd_edma)
include_if_use(driver_flexio_spi)
include_if_use(driver_flexio_spi_edma)
include_if_use(driver_flexio_uart)
include_if_use(driver_flexio_uart_edma)
include_if_use(driver_flexspi)
include_if_use(driver_flexspi_edma)
include_if_use(driver_fxos8700cq)
include_if_use(driver_i3c)
include_if_use(driver_iomuxc)
include_if_use(driver_irqsteer)
include_if_use(driver_isi)
include_if_use(driver_ldb_1)
include_if_use(driver_lpi2c)
include_if_use(driver_lpi2c_edma)
include_if_use(driver_lpi2c_freertos)
include_if_use(driver_lpit)
include_if_use(driver_lpspi)
include_if_use(driver_lpspi_edma)
include_if_use(driver_lpspi_freertos)
include_if_use(driver_lptmr)
include_if_use(driver_lpuart)
include_if_use(driver_lpuart_edma)
include_if_use(driver_lpuart_freertos)
include_if_use(driver_lsm6dso)
include_if_use(driver_memory)
include_if_use(driver_mipi_csi2rx_dwc)
include_if_use(driver_mipi_dsi_imx)
include_if_use(driver_msgintr)
include_if_use(driver_mu1)
include_if_use(driver_nand_flash-common)
include_if_use(driver_nand_flash-controller-flexspi)
include_if_use(driver_netc)
include_if_use(driver_netc_imx95)
include_if_use(driver_nor_flash-common)
include_if_use(driver_nor_flash-controller-flexspi)
include_if_use(driver_nor_flash-controller-lpspi)
include_if_use(driver_pca6416a)
include_if_use(driver_pcal6408)
include_if_use(driver_pcal6524)
include_if_use(driver_pdm)
include_if_use(driver_pdm_edma)
include_if_use(driver_pf1550)
include_if_use(driver_phy-common)
include_if_use(driver_phy-device-aqr113c)
include_if_use(driver_phy-device-ar8031)
include_if_use(driver_phy-device-dp83848)
include_if_use(driver_phy-device-ksz8041)
include_if_use(driver_phy-device-ksz8081)
include_if_use(driver_phy-device-lan8720a)
include_if_use(driver_phy-device-lan8741)
include_if_use(driver_phy-device-rtl8201)
include_if_use(driver_phy-device-rtl8211f)
include_if_use(driver_phy-device-vsc8541)
include_if_use(driver_rgpio)
include_if_use(driver_sai)
include_if_use(driver_sai_edma)
include_if_use(driver_sar_adc)
include_if_use(driver_sema42)
include_if_use(driver_sentinel)
include_if_use(driver_sgtl5000)
include_if_use(driver_sm)
include_if_use(driver_srtm)
include_if_use(driver_srtm_freertos)
include_if_use(driver_tpm)
include_if_use(driver_trdc_1)
include_if_use(driver_trdc_soc)
include_if_use(driver_trgmux)
include_if_use(driver_tstmr)
include_if_use(driver_video-common)
include_if_use(driver_video-i2c)
include_if_use(driver_wdog32)
include_if_use(driver_wm8960)
include_if_use(driver_wm8962)
include_if_use(middleware_baremetal)
...
include_if_use(middleware_multicore_rpmsg_lite_imx95_m33_bm)
include_if_use(middleware_multicore_rpmsg_lite_imx95_m33_freertos)
include_if_use(middleware_multicore_rpmsg_lite_imx95_m7_bm)
include_if_use(middleware_multicore_rpmsg_lite_imx95_m7_freertos)
include_if_use(middleware_multicore_rpmsg_lite_xos)
include_if_use(middleware_pkcs11)
include_if_use(middleware_tinycbor)
include_if_use(utilities_misc_utilities)
include_if_use(utility_assert)
include_if_use(utility_assert_lite)
include_if_use(utility_debug_console)
include_if_use(utility_debug_console_lite)
include_if_use(utility_notifier)
include_if_use(utility_shell)
include_if_use(utility_str)
