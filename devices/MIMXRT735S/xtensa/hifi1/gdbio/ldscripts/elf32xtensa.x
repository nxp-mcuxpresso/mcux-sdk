/* This linker script generated from xt-genldscripts.tpp for LSP /home/imxrt700_verif1/hifi_library/hifi1/xtensa-elf/lib/min-rt-local */
/* Linker Script for default link or ld -n or ld -N */
MEMORY
{
  ...
  iram0_0_seg :                       	org = 0x00598000, len = 0x18000
  dram0_0_seg :                       	org = 0x205B0000, len = 0x10000
}
...
_memmap_mem_iram0_end   = 0x5B0000;
_memmap_mem_dram0_start = 0x205b0000;
_memmap_mem_dram0_end   = 0x205c0000;
...
_memmap_seg_iram0_0_start = 0x598000;
_memmap_seg_iram0_0_max   = 0x5B0000;
_memmap_seg_dram0_0_start = 0x205b0000;
_memmap_seg_dram0_0_max   = 0x205c0000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x205c0000);
  _heap_sentry = 0x205c0000;
