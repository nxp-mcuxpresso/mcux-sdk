...
#  set(CONFIG_USE_device_KW45B41Z83_startup_wireless true)
...
#  # description: Middleware wireless ble_profiles_digital_key
#  set(CONFIG_USE_middleware_wireless_ble_profiles_digital_key true)

#set.device.KW45B41Z83
...
#  # description: Devices_project_template KW45B41Z83
...
#  # description: Device KW45B41Z83_cmsis
...
#  # description: Device KW45B41Z83_system
...
#  # description: LIN Stack Driver
#  set(CONFIG_USE_driver_lin_stack true)
...
#  # description: Component power manager Device Level
#  set(CONFIG_USE_component_power_manager_lockw45b41z true)
...
#  # description: Multicore Manager for kw45b41zevk board
#  set(CONFIG_USE_middleware_multicore_mcmgr_kw45b41 true)
...
#  # description: RPMsg-Lite for kw45b41zloc baremetal application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_kw45b41zloc_bm true)

#  # description: RPMsg-Lite for kw45b41zloc baremetal application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_kw45b41zloc_nbu_bm true)

#  # description: RPMsg-Lite_kw45b41zloc_nbu_porting_layer
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_kw45b41zloc_nbu_threadx true)

#  # description: RPMsg-Lite for kw45b41zloc FreeRTOS application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_kw45b41zloc_freertos true)

#  # description: RPMsg-Lite baremetal for kw45b41zloc board
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_bm_config_kw45b41zloc true)

#  # description: RPMsg-Lite FreeRTOS for kw45b41zloc board
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_freertos_config_kw45b41zloc true)

#  # description: RPMsg-Lite for kw45b41zevk baremetal application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_kw45b41zevk_bm true)

#  # description: RPMsg-Lite for kw45b41zevk baremetal application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_kw45b41zevk_nbu_bm true)

#  # description: RPMsg-Lite_kw45b41zevk_nbu_porting_layer
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_kw45b41zevk_nbu_threadx true)

#  # description: RPMsg-Lite for kw45b41zevk FreeRTOS application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_kw45b41zevk_freertos true)

#  # description: RPMsg-Lite baremetal for kw45b41zevk board
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_bm_config_kw45b41zevk true)

#  # description: RPMsg-Lite FreeRTOS for kw45b41zevk board
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_freertos_config_kw45b41zevk true)
...
#  set(CONFIG_USE_middleware_wireless_framework_LPM_KW45B41Z83 true)

#  # description: Middleware wireless framework_lpm_systicks
#  set(CONFIG_USE_middleware_wireless_framework_LPM_systicks_KW45B41Z83 true)

#  # description: Middleware wireless framework_lpm_cli
#  set(CONFIG_USE_middleware_wireless_framework_LPM_cli_KW45B41Z83 true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/kw45b41zevk
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/kw45b41zloc
)

include(set_board_kw45b41zevk OPTIONAL)
include(set_board_kw45b41zloc OPTIONAL)
include(set_CMSIS_DSP_Lib OPTIONAL)
include(set_CMSIS OPTIONAL)
include(set_device_KW45B41Z83 OPTIONAL)
