...
#if !defined(K32L2A31A_H_)
#define K32L2A31A_H_                             /**< Symbol preventing repeated inclusion */
...
typedef struct {
  __IO uint32_t CLKCFG[121];                       /**< PCC CLKCFG Register, array offset: 0x0, array step: 0x4, irregular array, not all indices are valid */
} PCC_Type;
...
typedef struct {
  __IO uint32_t TRGCFG[14];                        /**< TRGMUX TRGCFG Register, array offset: 0x0, array step: 0x4, irregular array, not all indices are valid */
} TRGMUX_Type;
