...
mcux_include_as_kconfig(driver_llwu)
mcux_include_as_kconfig(CMSIS_Include_dsp)
mcux_include_as_kconfig(driver_i2c)
...
mcux_include_as_kconfig(driver_rnga)
mcux_include_as_kconfig(utility_shell)
mcux_include_as_kconfig(utility_notifier)
mcux_include_as_kconfig(driver_wdog)
mcux_include_as_kconfig(CMSIS_Include_core_cm0plus)
mcux_include_as_kconfig(driver_sysmpu)
mcux_include_as_kconfig(driver_vref)
mcux_include_as_kconfig(driver_mmau)
mcux_include_as_kconfig(driver_spi)
mcux_include_as_kconfig(driver_flash)
mcux_include_as_kconfig(component_uart_adapter)
mcux_include_as_kconfig(utility_assert)
mcux_include_as_kconfig(middleware_mmcau_cm0p)
mcux_include_as_kconfig(driver_sim)
mcux_include_as_kconfig(utility_debug_console)
mcux_include_as_kconfig(device_CMSIS)
mcux_include_as_kconfig(driver_uart)
mcux_include_as_kconfig(driver_qtmr_2)
...
mcux_include_as_kconfig(driver_uart_dma)
mcux_include_as_kconfig(driver_smc)
mcux_include_as_kconfig(driver_crc)
mcux_include_as_kconfig(driver_spi_dma)
mcux_include_as_kconfig(driver_dma)
mcux_include_as_kconfig(component_serial_manager)
mcux_include_as_kconfig(driver_slcd)
mcux_include_as_kconfig(driver_pit)
mcux_include_as_kconfig(driver_afe)
mcux_include_as_kconfig(component_serial_manager_uart)
mcux_include_as_kconfig(driver_slcd_gdh_1247wp)
mcux_include_as_kconfig(driver_pmc)
mcux_include_as_kconfig(driver_rcm)
mcux_include_as_kconfig(driver_slcd_engine)
mcux_include_as_kconfig(driver_xbar)
