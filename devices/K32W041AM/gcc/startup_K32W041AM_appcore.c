//*****************************************************************************
// K32W041AM Microcontroller Startup code for use with LPCXpresso IDE
//
// Version : 141204
//*****************************************************************************
//
...
__attribute__((used, section(".isr_vector"))) void (*const g_pfnVectors[])(void) = {
    ...
    FLEXCOMM0_IRQHandler, FLEXCOMM1_IRQHandler, FLEXCOMM2_IRQHandler, FLEXCOMM3_IRQHandler, FLEXCOMM4_IRQHandler,
    FLEXCOMM5_IRQHandler, PWM0_IRQHandler, /*!< PWM channel 0  interrupt */
    ...
    FLEXCOMM6_IRQHandler, RTC_IRQHandler, NFCTag_IRQHandler, MAILBOX_IRQHandler, ADC_SEQA_IRQHandler,
    ADC_SEQB_IRQHandler, ADC_THCMP_OVR_IRQHandler, DMIC0_IRQHandler, HWVAD0_IRQHandler, BLE_DP_IRQHandler,
    BLE_DP0_IRQHandler, BLE_DP1_IRQHandler, BLE_DP2_IRQHandler, BLE_LL_ALL_IRQHandler, ZIGBEE_MAC_IRQHandler,
    ZIGBEE_MODEM_IRQHandler, RFP_TMU_IRQHandler, RFP_AGC_IRQHandler, ISO7816_IRQHandler, ANA_COMP_IRQHandler,
    WAKE_UP_TIMER0_IRQHandler, WAKE_UP_TIMER1_IRQHandler, PVT_AMBER0_IRQHandler, PVT_RED0_IRQHandler,
    PVT_AMBER1_IRQHandler, PVT_RED1_IRQHandler, BLE_WakeupTimer_IRQHandler, /*!<BLE Wakeup timer interrupt */
#if !defined(CPU_JN518X_REV) || (CPU_JN518X_REV > 1)
