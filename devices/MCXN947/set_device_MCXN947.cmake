...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_sai AND (CONFIG_DEVICE_ID STREQUAL MCXN947))
...
if(CONFIG_USE_driver_edma4 AND (CONFIG_DEVICE_ID STREQUAL MCXN947) AND CONFIG_USE_driver_common AND CONFIG_USE_driver_lpflexcomm)
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_lpspi AND (CONFIG_DEVICE_ID STREQUAL MCXN947) AND CONFIG_USE_driver_common AND CONFIG_USE_driver_lpflexcomm)
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_lpi2c AND (CONFIG_DEVICE_ID STREQUAL MCXN947) AND CONFIG_USE_driver_common AND CONFIG_USE_driver_lpflexcomm)
...
if(CONFIG_USE_driver_lpuart_edma AND (CONFIG_DEVICE_ID STREQUAL MCXN947) AND CONFIG_USE_driver_lpuart AND CONFIG_USE_CMSIS_Driver_Include_USART AND CONFIG_USE_RTE_Device)
...
if(CONFIG_USE_driver_lpspi_edma AND (CONFIG_DEVICE_ID STREQUAL MCXN947) AND CONFIG_USE_driver_lpspi AND CONFIG_USE_CMSIS_Driver_Include_SPI AND CONFIG_USE_RTE_Device)
...
if(CONFIG_USE_driver_lpi2c_edma AND (CONFIG_DEVICE_ID STREQUAL MCXN947) AND CONFIG_USE_driver_lpi2c AND CONFIG_USE_CMSIS_Driver_Include_I2C AND CONFIG_USE_RTE_Device)
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_flexcan AND (CONFIG_DEVICE_ID STREQUAL MCXN947))
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_flexio_spi AND (CONFIG_DEVICE_ID STREQUAL MCXN947))
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_flexio_uart AND (CONFIG_DEVICE_ID STREQUAL MCXN947))
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_pdm AND (CONFIG_DEVICE_ID STREQUAL MCXN947))
...
message(SEND_ERROR "driver_sema42.MCXN947 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_qdc.MCXN947 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_power_manager_core.MCXN947 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_component_power_manager_MCXN94x)
# Add set(CONFIG_USE_component_power_manager_MCXN94x true) in config.cmake to use this component

message("component_power_manager_MCXN94x component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_component_power_manager_core AND CONFIG_USE_driver_mcx_spc AND CONFIG_USE_driver_mcx_cmc AND CONFIG_USE_driver_mcx_vbat AND CONFIG_USE_driver_wuu AND CONFIG_USE_driver_clock AND CONFIG_USE_driver_crc AND (CONFIG_DEVICE_ID STREQUAL MCXN947))

target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../components/power_manager/devices/MCXN947/fsl_pm_device.c
)
...
message(SEND_ERROR "component_power_manager_MCXN94x.MCXN947 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mem_manager_freertos.MCXN947 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
