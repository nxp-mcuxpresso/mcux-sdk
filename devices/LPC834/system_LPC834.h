 ...
 * @version 1.1
 * @date 2018-02-25
 * @brief Device specific configuration file for LPC834 (header file)
 *
...
#ifndef _SYSTEM_LPC834_H_
#define _SYSTEM_LPC834_H_                        /**< Symbol preventing repeated inclusion */
