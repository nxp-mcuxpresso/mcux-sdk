...
/**
 * @file fxls8961_poll.c
 * @brief The fxls8961_poll.c file implements the ISSDK FXLS8961 sensor driver
...
int main(void)
{
    ...
    PRINTF("\r\n ISSDK FXLS8961 sensor driver example demonstration with poll mode\r\n");
    ...
    for (;;) /* Forever loop */
    {
        ...
        status = FXLS8961_I2C_ReadData(&fxls8961Driver, cFxls8961DRDYEvent, &dataReady);
        if (0 == (dataReady & FXLS8961_INT_STATUS_SRC_DRDY_MASK))
        {
            continue;
        }
