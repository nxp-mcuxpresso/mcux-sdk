...
/**
 * @file lpc55s36.h
 * @brief The lpc55s36.h file defines GPIO pin mappings for LPCXpresso55S36 board
 */
...
#define SPI_S_DRIVER       Driver_SPI2
#define SPI_S_BAUDRATE     500000U ///< Transfer baudrate - 500k
#define SPI_S_DEVICE_INDEX SPI2_INDEX
#define SPI_S_SIGNAL_EVENT SPI2_SignalEvent_t
