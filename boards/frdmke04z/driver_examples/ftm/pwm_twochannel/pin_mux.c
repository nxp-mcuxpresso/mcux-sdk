...
void BOARD_InitPins(void) {
  ...
  PORT_SetPinSelect(kPORT_FTM2CH2, kPORT_FTM2_CH2_PTC4);     /* pin 2 is configured as FTM2_CH2 */
  PORT_SetPinSelect(kPORT_FTM2CH3, kPORT_FTM2_CH3_PTC5);     /* pin 1 is configured as FTM2_CH3 */
  SIM->SOPT = ((SIM->SOPT &
    (~(SIM_SOPT_CLKOE_MASK)))                                /* Mask bits to zero which are setting */
      | SIM_SOPT_CLKOE(0x00u)                                /* Bus Clock Output Enable: 0x00u */
    );
}
