...
/* Routed pin properties */
#define BOARD_INITSECUREI2CPINS_SECURITY_RST_BOOT_MODE1_PERIPHERAL         GPIO6   /*!< Peripheral name */
#define BOARD_INITSECUREI2CPINS_SECURITY_RST_BOOT_MODE1_SIGNAL       gpio_mux_io   /*!< Signal name */
