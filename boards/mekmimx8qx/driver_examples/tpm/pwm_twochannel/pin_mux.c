...
- pin_list:
  ...
  - {pin_num: R33, peripheral: M40__TPM0, signal: 'tpm_ch, 1', pin_signal: SPI0_CS0, PULL: PULL_0, sw_config: sw_config_0}
  - {pin_num: P34, peripheral: M40__TPM0, signal: 'tpm_ch, 0', pin_signal: SPI0_SDI, PULL: PULL_0, sw_config: sw_config_0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(sc_ipc_t ipc)                          /*!< Function assigned for the core: Cortex-M4F[m4] */
{
  ...
  err = sc_pad_set_all(ipc, BOARD_INITPINS_BB_SPI0_CS0_PIN_FUNCTION_ID, 2U, SC_PAD_CONFIG_NORMAL, SC_PAD_ISO_OFF, 0x0 ,SC_PAD_WAKEUP_OFF);/* IOMUXD_SPI0_CS0 register modification value */
  if (SC_ERR_NONE != err)
  {
      assert(false);
  }
  err = sc_pad_set_all(ipc, BOARD_INITPINS_BB_SPI0_MISO_PIN_FUNCTION_ID, 2U, SC_PAD_CONFIG_NORMAL, SC_PAD_ISO_OFF, 0x0 ,SC_PAD_WAKEUP_OFF);/* IOMUXD_SPI0_SDI register modification value */
  if (SC_ERR_NONE != err)
  {
      assert(false);
  }
