...
void BOARD_InitPins(void) {
    ...
    IOMUXC_SetPinConfig(
        ...
        0x10B0U);                               /* Slew Rate Field: Slow Slew Rate
                                                   ...
                                                   Hyst. Enable Field: Hysteresis Disabled */
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_SD_B0_04_CCM_CLKO1,         /* GPIO_SD_B0_04 is configured as CCM_CLKO1 */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_SD_B0_05_CCM_CLKO2,         /* GPIO_SD_B0_05 is configured as CCM_CLKO2 */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_SD_B0_04_CCM_CLKO1,         /* GPIO_SD_B0_04 PAD functional properties : */
        0x10B0U);                               /* Slew Rate Field: Slow Slew Rate
                                                   Drive Strength Field: R0/6
                                                   Speed Field: medium(100MHz)
                                                   Open Drain Enable Field: Open Drain Disabled
                                                   ...
                                                   Hyst. Enable Field: Hysteresis Disabled */
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_SD_B0_05_CCM_CLKO2,         /* GPIO_SD_B0_05 PAD functional properties : */
        0x10B0U);                               /* Slew Rate Field: Slow Slew Rate
                                                   Drive Strength Field: R0/6
                                                   Speed Field: medium(100MHz)
                                                   Open Drain Enable Field: Open Drain Disabled
