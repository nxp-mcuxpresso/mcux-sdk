...
#define BOARD_SDMMC_SD_CD_GPIO_BASE      RGPIO4
...
#define BOARD_SDMMC_SD_POWER_RESET_GPIO_BASE RGPIO4
#define BOARD_SDMMC_SD_POWER_RESET_GPIO_PORT 4
#define BOARD_SDMMC_SD_POWER_RESET_GPIO_PIN  14U
/*! @brief SD IO voltage */
#define BOARD_SDMMC_SD_IO_VOLTAGE_CONTROL_TYPE kSD_IOVoltageCtrlByGpio
#define BOARD_SDMMC_SD_VSELECT_GPIO_BASE       RGPIO5
#define BOARD_SDMMC_SD_VSELECT_GPIO_PORT       5
#define BOARD_SDMMC_SD_VSELECT_GPIO_PIN        2U
