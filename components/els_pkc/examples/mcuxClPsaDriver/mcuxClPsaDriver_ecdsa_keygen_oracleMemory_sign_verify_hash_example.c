...
bool nxpClPsaDriver_ecdsa_keygen_oracleMemory_sign_verify_hash_example(void)
{
    bool result = mcuxClPsaDriver_ecdsa_keygen_oracleMemory_sign_verify_hash_example();
    return result;
}
