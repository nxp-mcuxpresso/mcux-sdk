...
#ifndef MCUX_PSA_S4XX_OPAQUE_AEAD_H
#define MCUX_PSA_S4XX_OPAQUE_AEAD_H
 ...
 */
psa_status_t ele_s4xx_opaque_aead_encrypt_setup(
    ele_opaque_aead_operation_t *operation,
 ...
 * \retval #PSA_ERROR_NOT_SUPPORTED
 */
psa_status_t ele_s4xx_opaque_aead_decrypt_setup(
    ele_opaque_aead_operation_t *operation,
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
    psa_algorithm_t alg);
 ...
 */
psa_status_t ele_s4xx_opaque_aead_set_nonce(
    ele_opaque_aead_operation_t *operation,
    const uint8_t *nonce,
    size_t nonce_length);
 ...
 * \retval #PSA_ERROR_NOT_SUPPORTED
 */
psa_status_t ele_s4xx_opaque_aead_set_lengths(
    ele_opaque_aead_operation_t *operation,
    size_t ad_length,
 ...
 * \retval #PSA_ERROR_DATA_INVALID
 */
psa_status_t ele_s4xx_opaque_aead_update_ad(
    ele_opaque_aead_operation_t *operation,
    const uint8_t *input,
    size_t input_size);
 ...
 * \retval #PSA_ERROR_DATA_INVALID
 */
psa_status_t ele_s4xx_opaque_aead_update(
    ele_opaque_aead_operation_t *operation,
    const uint8_t *input,
    size_t input_length,
    uint8_t *output,
 ...
 * \retval #PSA_ERROR_NOT_SUPPORTED
 */
psa_status_t ele_s4xx_opaque_aead_finish(
    ele_opaque_aead_operation_t *operation,
    uint8_t *ciphertext,
 ...
 * \retval #PSA_ERROR_NOT_SUPPORTED
 */
psa_status_t ele_s4xx_opaque_aead_verify(
    ele_opaque_aead_operation_t *operation,
    uint8_t *plaintext,
 ...
 * \retval #PSA_ERROR_NOT_SUPPORTED
 */
psa_status_t ele_s4xx_opaque_aead_abort(ele_opaque_aead_operation_t *operation);
...
#endif
#endif /* MCUX_PSA_S4XX_OPAQUE_AEAD_H */
