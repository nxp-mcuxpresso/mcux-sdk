...
#ifndef MCUX_PSA_S4XX_OPAQUE_MAC_H
#define MCUX_PSA_S4XX_OPAQUE_MAC_H

/** \file mcux_psa_s4xx_mac.h
 *
 ...
 *          failure
 */
psa_status_t ele_s4xx_opaque_mac_sign_setup(ele_s4xx_opaque_mac_operation_t *operation,
 ...
 *          failure
 */
psa_status_t ele_s4xx_opaque_mac_verify_setup(ele_s4xx_opaque_mac_operation_t *operation,
                                              const psa_key_attributes_t *attributes,
                                              const uint8_t *key_buffer,
 ...
 *          failure
 */
psa_status_t ele_s4xx_opaque_mac_update(ele_s4xx_opaque_mac_operation_t *operation,
                                        const uint8_t *input, size_t input_length);
/*!
 ...
 *          failure
 */
psa_status_t ele_s4xx_opaque_mac_sign_finish(ele_s4xx_opaque_mac_operation_t *operation,
                                             uint8_t *mac, size_t mac_size,
                                             size_t *mac_length);
/*!
 ...
 *          failure
 */
psa_status_t ele_s4xx_opaque_mac_verify_finish(ele_s4xx_opaque_mac_operation_t *operation,
 ...
 *          failure
 */
psa_status_t ele_s4xx_opaque_mac_abort(ele_s4xx_opaque_mac_operation_t *operation);
...
#endif
#endif /* MCUX_PSA_S4XX_OPAQUE_MAC_H */
