...
#ifndef MCUX_PSA_S4XX_HASH_H
#define MCUX_PSA_S4XX_HASH_H

/** \file mcux_psa_s4xx_hash.h
 *
 ...
 *          failure
 */
psa_status_t ele_s4xx_transparent_hash_finish(ele_s4xx_hash_operation_t *operation, uint8_t *hash,
