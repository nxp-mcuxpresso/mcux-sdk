...
#ifndef MCUX_PSA_S4XX_INIT_H
#define MCUX_PSA_S4XX_INIT_H

/** \file mcux_psa_s4xx_init.h
 *
 ...
 *          failure
 */
psa_status_t ele_s4xx_transparent_init(void);
 ...
 *          failure
 */
psa_status_t ele_s4xx_transparent_free(void);
