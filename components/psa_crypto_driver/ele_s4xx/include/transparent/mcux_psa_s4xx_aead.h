...
#ifndef MCUX_PSA_S4XX_AEAD_H
#define MCUX_PSA_S4XX_AEAD_H

/** \file mcux_psa_s4xx_aead.h
 *
 ...
 */
psa_status_t
ele_s4xx_transparent_aead_decrypt(const psa_key_attributes_t *attributes,
                                  const uint8_t *key_buffer, size_t key_buffer_size,
                                  psa_algorithm_t alg, const uint8_t *nonce,
                                  size_t nonce_length, const uint8_t *additional_data,
 ...
 */
psa_status_t ele_s4xx_transparent_aead_encrypt_setup(
    ele_s4xx_aead_operation_t *operation,
 ...
 * \retval #PSA_ERROR_NOT_SUPPORTED
 */
psa_status_t ele_s4xx_transparent_aead_decrypt_setup(
    ele_s4xx_aead_operation_t *operation,
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
    psa_algorithm_t alg);
 ...
 */
psa_status_t ele_s4xx_transparent_aead_set_nonce(
    ele_s4xx_aead_operation_t *operation,
    const uint8_t *nonce,
    size_t nonce_length);
 ...
 * \retval #PSA_ERROR_NOT_SUPPORTED
 */
psa_status_t ele_s4xx_transparent_aead_set_lengths(
    ele_s4xx_aead_operation_t *operation,
    size_t ad_length,
 ...
 * \retval #PSA_ERROR_DATA_INVALID
 */
psa_status_t ele_s4xx_transparent_aead_update_ad(
    ele_s4xx_aead_operation_t *operation,
    const uint8_t *input,
    size_t input_size);
 ...
 * \retval #PSA_ERROR_DATA_INVALID
 */
psa_status_t ele_s4xx_transparent_aead_update(
    ele_s4xx_aead_operation_t *operation,
    const uint8_t *input,
    size_t input_length,
    uint8_t *output,
 ...
 * \retval #PSA_ERROR_NOT_SUPPORTED
 */
psa_status_t ele_s4xx_transparent_aead_finish(
    ele_s4xx_aead_operation_t *operation,
    uint8_t *ciphertext,
 ...
 * \retval #PSA_ERROR_NOT_SUPPORTED
 */
psa_status_t ele_s4xx_transparent_aead_verify(
    ele_s4xx_aead_operation_t *operation,
    uint8_t *plaintext,
 ...
 * \retval #PSA_ERROR_NOT_SUPPORTED
 */
psa_status_t ele_s4xx_transparent_aead_abort(ele_s4xx_aead_operation_t *operation);
